...
# Source: https://jrudlin.github.io/2018/05/21/intune-powershell-report-of-all-apps-and-their-assignment-properties/

# RD - v2 Update Notes:
# Replaced Function Get-IntuneApplication / Get-ApplicationAssignment / 
# Source:https://github.com/microsoftgraph/powershell-intune-samples/blob/master/Applications/Application_InstallStats.ps1
# Updated from beta to V1.0
# Required Scopes: DeviceManagementApps.Read.All, DeviceManagementApps.ReadWrite.All

# MGGraph Login Added - Connect-MGGraph -Scopes DeviceManagementApps.Read.All, DeviceManagementApps.ReadWrite.All
# AzureAD Login Added 
...
# Output to CSV:
$output | Select Name,Group,Assignment,Platform | Export-CSV -Path "C:\_IT-Temp\ABL_InTune-App_Audit_$(Get-Date -f yyyy-MM-dd).csv" -NoTypeInformation

Invoke-Item C:\_IT-Temp
